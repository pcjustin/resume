...
1. C/C++
1. Python
1. Ubuntu/Debian / Redhat
1. Javascript / jQuery
1. Java
1. SSL protocol / OpenSSL
1. Bluetooth stack / BlueZ
1. HTTP / HTTPS / HTTP2
1. Git / Gerrit/ SVN / Jenkins / Jira
1. MySQL
...
**Pax Technology** Communications Software Engineer __2016 to present__
	Work on ARM and MIPS platform many years even Broadcom, ARM9 and ARM11.
	Improve the company to use Git / Gerrit to version control the projects and code review.
...
**Sierra Wireless** Senior Consultant __2015 to 2016__
	Using Git to version control the projects and use Jira to apply the application.
...
**Pegatron** Senior Software Engineer __2010 to 2014__
	Using UART, SPI, and I2C to control the device and transfer the data.
